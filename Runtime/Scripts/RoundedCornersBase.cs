...
{
    public virtual string cacheFolderPath { get { return "Assets/RoundedCornersMaterials"; } }
    ...
    public void RefreshMaterialFolder()
    {
        ...
        {
            RoundedCornersBase[] _roundedCorners = (RoundedCornersBase[])FindObjectsOfTypeAll(typeof(RoundedCornersBase));
